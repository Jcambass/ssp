...
function meta:drawFaded(x, y, alpha, ditherType)
  -- Draw image with Bayer dithering using the playbit shader
  
  -- Enable dithering in the playbit shader
  playbit.graphics.shader:send("ditherEnabled", true)
  playbit.graphics.shader:send("ditherAlpha", alpha)
  
  -- Draw with the shader
  love.graphics.draw(self.data, x, y)
  
  -- Disable dithering
  playbit.graphics.shader:send("ditherEnabled", false)
